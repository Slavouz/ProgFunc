expenses = [
    ...
    {'tanggal':  '2023-07-26', 'deskripsi': 'Belanja', 'jumlah': 10000},
]
...
def generate_expenses_report(expenses):
    for expense in expenses:
        yield f"Tangggal: {expense['tanggal']} - Deskripsi: {expense['deskripsi']} - Jumlah Rp: {expense['jumlah']}"

# TODO 5 pastikan semua fungsi yang ada sudah berupa pure function;

def add_expense_intractively(expenses):
    date = input("Masukkan tangal pengeluaran (YYYY-MM-DD) : ")
    ...
    new_expenses = add_expense(expenses, expense)
...
def display_menu():
    print("\n===== Apliaksi Pencatat Pengeluaran Harian =====")
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            expenses = add_expense_intractively(expenses)
        elif choice == 2:
